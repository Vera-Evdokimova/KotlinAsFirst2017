 ...
 */
fun mean(list: List<Double>): Double = if (!list.isNotEmpty()) 0.0 else (list.sum() / list.size)
...
fun russian(n: Int): String {
    ...
    for (e in z) {
        ...
        if (j == 1) {
            when {
                (e % 100 in 11..14) -> result.add("тысяч")
